{{/*
Reusable livenessProbe template for leaderboard service
*/}}
{{- define "leaderboard.livenessProbe" -}}
livenessProbe:
  httpGet:
...
{{/*
Reusable readinessProbe template for leaderboard service
*/}}
{{- define "leaderboard.readinessProbe" -}}
readinessProbe:
  httpGet:
...
{{/*
Reusable startupProbe template for leaderboard service
*/}}
{{- define "leaderboard.startupProbe" -}}
startupProbe:
  httpGet:
