{{/*
Reusable livenessProbe template for simulation service
*/}}
{{- define "simulation.livenessProbe" -}}
livenessProbe:
  httpGet:
...
{{/*
Reusable readinessProbe template for simulation service
*/}}
{{- define "simulation.readinessProbe" -}}
readinessProbe:
  httpGet:
...
{{/*
Reusable startupProbe template for simulation service
*/}}
{{- define "simulation.startupProbe" -}}
startupProbe:
  httpGet:
