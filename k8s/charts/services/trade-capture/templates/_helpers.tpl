{{/*
Reusable livenessProbe template for trade-capture service
*/}}
{{- define "trade-capture.livenessProbe" -}}
livenessProbe:
  httpGet:
...
{{/*
Reusable readinessProbe template for trade-capture service
*/}}
{{- define "trade-capture.readinessProbe" -}}
readinessProbe:
  httpGet:
...
{{/*
Reusable startupProbe template for trade-capture service
*/}}
{{- define "trade-capture.startupProbe" -}}
startupProbe:
  httpGet:
