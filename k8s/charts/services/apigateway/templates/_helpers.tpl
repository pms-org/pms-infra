{{/*
Reusable livenessProbe template for apigateway service
*/}}
...
{{/*
Reusable readinessProbe template for apigateway service
*/}}
...
{{/*
Reusable startupProbe template for apigateway service
*/}}
{{- define "apigateway.startupProbe" -}}
startupProbe:
  httpGet:
