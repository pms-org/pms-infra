{{/*
Reusable livenessProbe template for auth service
*/}}
{{- define "auth.livenessProbe" -}}
livenessProbe:
  httpGet:
...
{{/*
Reusable readinessProbe template for auth service
*/}}
{{- define "auth.readinessProbe" -}}
readinessProbe:
  httpGet:
...
{{/*
Reusable startupProbe template for auth service
*/}}
{{- define "auth.startupProbe" -}}
startupProbe:
  httpGet:
