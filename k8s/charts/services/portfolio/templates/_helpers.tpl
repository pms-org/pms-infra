{{/*
Reusable livenessProbe template for portfolio service
*/}}
{{- define "portfolio.livenessProbe" -}}
livenessProbe:
  httpGet:
...
{{/*
Reusable readinessProbe template for portfolio service
*/}}
{{- define "portfolio.readinessProbe" -}}
readinessProbe:
  httpGet:
...
{{/*
Reusable startupProbe template for portfolio service
*/}}
{{- define "portfolio.startupProbe" -}}
startupProbe:
  httpGet:
