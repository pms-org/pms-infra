{{/*
Reusable livenessProbe template for frontend service
*/}}
...
{{/*
Reusable readinessProbe template for frontend service
*/}}
...
{{/*
Reusable startupProbe template for frontend service
*/}}
{{- define "frontend.startupProbe" -}}
startupProbe:
  httpGet:
