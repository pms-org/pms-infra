{{/*
Reusable livenessProbe template for transactional service
*/}}
{{- define "transactional.livenessProbe" -}}
livenessProbe:
  httpGet:
...
{{/*
Reusable readinessProbe template for transactional service
*/}}
{{- define "transactional.readinessProbe" -}}
readinessProbe:
  httpGet:
...
{{/*
Reusable startupProbe template for transactional service
*/}}
{{- define "transactional.startupProbe" -}}
startupProbe:
  httpGet:
