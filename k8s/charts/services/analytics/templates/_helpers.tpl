{{/*
Reusable livenessProbe template for analytics service
*/}}
{{- define "analytics.livenessProbe" -}}
livenessProbe:
  httpGet:
...
{{/*
Reusable readinessProbe template for analytics service
*/}}
{{- define "analytics.readinessProbe" -}}
readinessProbe:
  httpGet:
...
{{/*
Reusable startupProbe template for analytics service
*/}}
{{- define "analytics.startupProbe" -}}
startupProbe:
  httpGet:
